...
//                                 \   /
//                                  \ /
//          n1 ㅡ ㅡ (10.1.1.0) ㅡ ㅡ n0 ㅡ ㅡ (10.1.4.0) ㅡ ㅡ n4
//                                  /  \
//                                 /    \
//                         (10.1.6.0)  (10.1.5.0)     
//                               /        \
...
// Packet 1
  ...
  ApplicationContainer serverApps1 = echoServer1.Install (p2pNodes3.Get (1));
  serverApps1.Start (Seconds (1.0));
  serverApps1.Stop (Seconds (30.0));

  UdpEchoClientHelper echoClient1 (p2pInterfaces3.GetAddress (1), 9);
  echoClient1.SetAttribute ("MaxPackets", UintegerValue (1));
  echoClient1.SetAttribute ("Interval", TimeValue (Seconds (1.0)));
  echoClient1.SetAttribute ("PacketSize", UintegerValue (1024));


  ApplicationContainer clientApps1 = echoClient1.Install (p2pNodes6.Get (1));
...
// 5-2. Application for throughput test
 ...
 // Packet 1
  ...
  ApplicationContainer clientApps1 = echoClient1.Install (p2pNodes4.Get (1));
  clientApps1.Start (Seconds (clientapptime));
...
// Packet 2
  ...
  ApplicationContainer serverApps2 = echoServer2.Install (p2pNodes5.Get (1));
  serverApps2.Start (Seconds (1.0));
  serverApps2.Stop (Seconds (simTime));

  UdpEchoClientHelper echoClient2 (p2pInterfaces5.GetAddress (1), 10);
...
// Packet 3
  ...
  ApplicationContainer serverApps3 = echoServer3.Install (p2pNodes6.Get (1));
  serverApps3.Start (Seconds (1.0));
  serverApps3.Stop (Seconds (simTime));

  UdpEchoClientHelper echoClient3 (p2pInterfaces6.GetAddress (1), 11);
  echoClient3.SetAttribute ("MaxPackets", UintegerValue (3));
  echoClient3.SetAttribute ("Interval", TimeValue (Seconds (1.0)));
  echoClient3.SetAttribute ("PacketSize", UintegerValue (1024));

  ApplicationContainer clientApps3 = echoClient3.Install (p2pNodes3.Get (1));
